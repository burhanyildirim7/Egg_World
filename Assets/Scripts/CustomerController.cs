...
public class CustomerController : MonoBehaviour
{
    ...
    void Update()
    {
        //Debug.Log("Al�nmas� Gereken yumurta say�s� = " + numberOfEggs);
    ...
    void MoveToCashier()
    {
        //Debug.Log("MOVETOCASHIER �ALI�IYOR");
        if (transform.position != new Vector3(target.transform.position.x, 0, target.transform.position.z) && canWalk)
        {
    ...
    void ShoppingStart()
    {
        //Debug.Log("SHOPPUNGSTART �ALI�IYOR");
    ...
    {
        //Debug.Log("CUSTOMERCOLLECTEGG �ALI�IYOR");
        time += Time.deltaTime;
