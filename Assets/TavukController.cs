...
public class AnimalsController : MonoBehaviour
{
    ...
    public void KumesCheck()
    {
        ...
        if (transform.localPosition == new Vector3(0, -3f, 11))
        {
            ...
            target = new Vector3(0, 0.2f, 3);


        }
        else if (transform.localPosition == new Vector3(0, 0.2f, 3))
        {
            target = new Vector3(0, 0.2f, -1);
        ...
        else if (transform.localPosition == new Vector3(0, 0.2f, -1f))
        {
            ...
            if (delayTime >= 8)
            {
                target = new Vector3(0, 0.2f, 3.2f);
